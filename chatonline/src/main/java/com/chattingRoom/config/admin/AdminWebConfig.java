package com.chattingRoom.config.admin;
/**
 * 用来配置拦截器的配置类
 */
...
import com.chattingRoom.constant.RuntimeConstant;
import com.chattingRoom.interceptor.admin.AdminAuthorityInterceptor;
import com.chattingRoom.interceptor.admin.AdminLoginInterceptor;
@Configuration
