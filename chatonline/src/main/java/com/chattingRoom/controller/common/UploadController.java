package com.chattingRoom.controller.common;
...
public class UploadController {
	...
	@Value("${chattingRoom.upload.photo.sufix}")
	private String uploadPhotoSufix;
	
	@Value("${chattingRoom.upload.photo.maxsize}")
	private long uploadPhotoMaxSize;
	
	@Value("${chattingRoom.upload.photo.path}")
	private String uploadPhotoPath;//图片保存位置
	
	@Value("${chattingRoom.upload.file.maxsize}")
	private long uploadFileMaxSize;
	
	@Value("${chattingRoom.upload.file.path}")
