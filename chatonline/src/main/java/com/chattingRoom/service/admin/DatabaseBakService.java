...
import com.chattingRoom.dao.admin.DatabaseBakDao;
import com.chattingRoom.entity.admin.DatabaseBak;
...
public class DatabaseBakService {
	...
	@Value("${chattingRoom.database.backup.dir}")
	private String backUpDir;
	@Value("${chattingRoom.database.backup.username}")
	private String dbUsername;
	@Value("${chattingRoom.database.backup.password}")
	private String dbPwd;
	@Value("${chattingRoom.database.backup.database.name}")
